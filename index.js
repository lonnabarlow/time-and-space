...
// ANSWER: No, because it is asking us to do more operations for the loop and the return. It can't be a O(n)
...
// ANSWER: No. because we don't know the size of the array, and space is taken up in direct relation to the size of the array.
...
// ANSWER: Each of the functions is dependant on the varrying size of the array + string, that we don't know, making them linear.
